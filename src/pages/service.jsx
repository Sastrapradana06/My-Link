...
export default function Services() {
  ...
  return (
    <div className="h-max my-6 w-full flex items-center justify-center flex-col gap-20">
      <PinContainer
        title="Order Me"
      ...
      >
        <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[16rem] h-[20rem] ">
          ...
          <div className="mt-5">
            <img src="/undangan.jfif" alt="" className="w-full h-[140px] object-cover rounded-lg" />
          </div>
        </div>
      </PinContainer>
      <PinContainer
      ...
      >
        <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[16rem] h-[20rem] ">
          ...
          <div className="mt-6">
            <img src="/classcrafter.png" alt="" className="w-full h-[140px] object-cover rounded-lg" />
          </div>
        </div>
      </PinContainer>
